...
class Kiyohime(commands.Cog):
	...
	async def on_message(self, message: discord.Message):
		...
		elif message.guild.me if isinstance(message.channel, discord.TextChannel) else self.bot.user in message.mentions:# and not (message.mention_everyone or message.role_mentions!=[]):
