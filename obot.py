...
cloudir = "/home/ubuntu/kiyo/cloud"
cloudirs = "/home/ubuntu/kiyo/cloud/"
...
async def status_task():
	...
	while True:
		await bot.change_presence(activity=discord.Game(name="with medjed's penis"))
		await asyncio.sleep(8)
		await bot.change_presence(activity=discord.Activity(name="pug's absolute PENIS", type=discord.ActivityType.watching))
		await asyncio.sleep(8)
...
async def gay(ctx):
	...
	x = []
	page = randint(1,15)
	posts = db.post_list(tags='yaoi',page=page,limit=100)
	for post in posts:
		try:
